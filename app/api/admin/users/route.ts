...
const ALL_PAGES = ["dashboard","crm","statements","medication-tasks","chats","blog","team","enrollments","contacts","credit-cards","vaccines","jobs","candidates","assistant","users","inventory"]

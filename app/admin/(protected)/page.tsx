...
export default async function AdminHomePage() {
  ...
  const visibleLinks =
    allowedPages === null
      ? sidebarLinks
      : sidebarLinks.filter(
          (link) => link.key === "dashboard" || allowedPages.includes(link.key)
        )
  ...
  return (
    <main className="min-h-screen bg-[#F7F5EF]">
        ...
        <div className="mx-auto w-full max-w-6xl px-6">
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-white/85">Welcome back, {displayName}</p>
            </div>
      ...
      <section className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-8 px-6 pb-16 pt-8 md:grid-cols-[220px_1fr]">
          ...
          <div className="mt-10 rounded-xl border border-emerald-900/10 bg-white p-6 shadow-sm">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <Link
                ...
                className="group rounded-lg border border-emerald-900/10 p-4 hover:bg-emerald-50"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">Bulk upload PDFs</p>
                  </div>
                </div>
              </Link>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">Manage email list</p>
                  </div>
                </div>
              </Link>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">Manage careers</p>
                  </div>
                </div>
              </Link>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">Write articles</p>
                  </div>
                </div>
              </Link>
            </div>

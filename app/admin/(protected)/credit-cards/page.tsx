    ...
    <main className="min-h-screen bg-[#F7F5EF]">
      <section className="relative isolate overflow-hidden" style={{ background: "linear-gradient(135deg,#0EA171 0%,#0B8F79 50%,#0B7C79 100%)", padding: "48px 0 56px" }}>
        <div className="mx-auto w-full max-w-6xl px-6">
          ...
          <h1 className="text-2xl font-semibold text-white md:text-3xl">Credit Card Updates</h1>
          <p className="mt-2 text-white/90">{c.t} total · {c.p} pending · {c.v} verified · {c.co} completed</p>
        </div>
      </section>

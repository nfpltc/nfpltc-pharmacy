...
import { Plus, Pencil, Trash2, Loader2, Shield, Key, X, Check } from "lucide-react"
...
const PAGE_LABELS: Record<string, string> = {
  ...
  assistant: "AI Assistant", social: "Social", settings: "Settings", users: "User Management",
}
  ...
  return (
    <div>
      <div className="mb-4 flex items-center justify-between">
        <p className="text-sm text-gray-500">Manage admin and staff accounts and their page access.</p>
        <button onClick={() => { setEditing(null); setShowModal(true) }} className="inline-flex items-center gap-1.5 rounded-lg bg-[#0B7C79] px-3 py-2 text-sm font-medium text-white hover:bg-[#0a6b68]"><Plus className="h-4 w-4" /> Add user</button>
      </div>
